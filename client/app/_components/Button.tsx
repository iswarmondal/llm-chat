  ...
  return (
    <button
      ...
      className={classNames(
        ...
        {
          "h-10 px-4 shadow-none hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] transition-shadow duration-100":
            size === "sm",
        },
        {
          "h-12 px-5 shadow-none hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] transition-shadow duration-100":
            size === "md",
        },
        {
          "h-14 px-5 shadow-none hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-shadow duration-100":
            size === "lg",
        },
        {
